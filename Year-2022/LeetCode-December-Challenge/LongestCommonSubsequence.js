var longestCommonSubsequence = function (text1, text2) {
    let dp;
    const LCS = (idx1, idx2, text1, text2) => {
    ...
    dp = Array(text1.length).fill(-1).map(()=> new Array(text2.length).fill(-1));
    return LCS(text1.length - 1, text2.length - 1, text1, text2);
};
let text1 = "",
